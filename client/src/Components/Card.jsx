  ...
  return (
    <div className="relative w-full h-full">
      ...
      >
        {/* FRONT */}
        <div
          className="absolute inset-0 backface-hidden bg-[var(--background)] rounded-3xl p-2 drop-shadow-2xl flex lg:flex-col overflow-hidden"
          ref={ref}
        >
        ...
        {/* BACK */}
        <div className="absolute inset-0 backface-hidden rotate-y-180 bg-[var(--background)] rounded-3xl p-4 flex flex-col items-center justify-center text-white">
